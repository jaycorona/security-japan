<?php
/*
  Name: WPCloud object cache
  Version: 1.0.0

  Install this file to wp-content/object-cache.php
 */

define('COMMAND_BASE_URL', 'http://wpcmd.wpcloud.jp/');
define('COMMAND_CACHE_CLEAR_URL', COMMAND_BASE_URL . 'v1/nginx/clear_cache/');
...
class WP_Object_Cache {
    ...
    var $wpc_clear_group = array('posts', 'comment');
    var $blog_prefix;
    ...
    function delete($key, $group = 'default', $deprecated = false) {
        ...
        if (in_array($group, $this->wpc_clear_group)) {
            self::clear_wpc_cache();
        }
    ...
    function clear_wpc_cache() {
        ...
        $cc_url = COMMAND_CACHE_CLEAR_URL . $key . '/';
        $cc_url .= $parsed_url['host'];
